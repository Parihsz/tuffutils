...
This module provides functionality to run tests, compare results, and benchmark performance.
...
- `input: (() -> any) | { any }`
  - The input to the function being tested. This can be a function that returns the input or an array of inputs.

- `expected: (() -> any) | any`
  - The expected output from the function being tested. This can be a function that returns the expected output or a direct value.
